...
$commands = "cd /var/www/html/app-citas ; sudo chown -R ubuntu:www-data . ; sudo chmod -R 777 storage bootstrap/cache database ; php artisan storage:link ; git fetch origin main ; git reset --hard origin/main ; composer install --no-dev --optimize-autoloader ; php artisan migrate --force ; php seed_services.php ; php artisan optimize:clear ; php artisan view:clear ; php artisan view:cache ; php artisan config:cache ; sudo service php8.2-fpm restart ; sudo systemctl restart nginx"
